...
class Admin extends Admin_Controller {
    ...
    protected $section = 'admin_chat';
    protected $namespace = 'chat';
    protected $slug_stream = 'chat';
    private $_tabs = array();
    ...
    public function __construct() {
        ...
        role_or_die('chat', 'admin_schedule');
    }
    ...
    public function index($page = 1) {
        ...
        $extra['columns'] = array('day', 'start_hour', 'end_hour');
        $this->streams->cp->entries_table($this->slug_stream, $this->namespace, 20, "admin/{$this->namespace}/index", true, $extra);
    }
