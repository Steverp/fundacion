...
class Module_projects extends Module {
    ...
    public $version = '1.2';
    public $mainTable = 'projects';
    public $chilTable = 'project_categories';
    public $imageTable = 'project_images';
    public $relationship = 'projects_categories';
    public $intro = 'projects_intro';
    ...
    public function info() {
        return array(
            ...
            'description' => array(
                'en' => 'projects © Brayan Acebo, luis fernando salazar 2014',
                'es' => 'Proyectos © Brayan Acebo, luis fernando salazar 2014',
            ),
            'frontend' => TRUE,
            'backend' => TRUE,
            'menu' => 'content'
    ...
    public function help() {
        return "Modulo de Proyectos con arbol de categorias y multiples imagenes";
    }
