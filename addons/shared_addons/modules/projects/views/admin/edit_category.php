    ...
    <div class="content">
        <div class="tabs">
            ...
            <div class="form_inputs" id="page-category">
                <?php echo form_open_multipart(site_url('admin/projects/update_category/' . $lang_admin), ''); ?>
                <div class="inline-form">
                    ...
                    <div class="buttons float-right padding-top">
                        ...
                        <a href="<?php echo site_url('admin/projects/index/' . $lang_admin . '#page-categories') ?>" class="btn red cancel">Cancelar</a>
                        <?php echo anchor('admin/projects/destroy_category/' . $category->id . '/' . $lang_admin, lang('global:delete'), array('class' => 'confirm btn red')); ?>
                    </div>
