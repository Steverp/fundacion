...
$(document).ready(function()
{
	...
	$(document).on("click ", ".outstanding_project", function(event)
	{
	...
	$(document).on("click ", ".promotions_project", function(event)
	{
		event.preventDefault();
		imageSrc = $(this).find('img').attr('src');
		element = $(this);
    ...
    {*/
   	...
   	function Sortable(element, subCatArray, idParent)
   	{
		...
		({
			type: "POST",
			dataType: "json",
			url: base_url+'admin/projects/orden_categories/',
   	...
   	({
        ...
        stop:   function(event, ui)
        {
            ...
            {
            	sortable_projects($(this), subCatArrayProd);
            }
        },
   	});
   	
   	function sortable_projects(element, subCatArray)
   	{
		$.ajax
		({
			type: "POST",
			dataType: "json",
			url: base_url+'admin/projects/orden_projects/',
