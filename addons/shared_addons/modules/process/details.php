...
class Module_process extends Module {

    public $version = '1.2';
    public $mainTable = 'process';
    public $chilTable = 'proces_categories';
    public $imageTable = 'proces_images';
    public $relationship = 'process_categories';
    public $intro = 'process_intro';
    ...
    public function info() {
        return array(
            ...
            'description' => array(
                'en' => 'process © Brayan Acebo, luis fernando salazar 2014',
    ...
    public function help() {
        return "Modulo de procesos con arbol de categorias y multiples imagenes";
    }
