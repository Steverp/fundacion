...
$(document).ready(function()
{
	...
	$(document).on("click ", ".outstanding_proces", function(event)
	{
	...
	$(document).on("click ", ".promotions_proces", function(event)
	{
		event.preventDefault();
		imageSrc = $(this).find('img').attr('src');
		element = $(this);
    ...
    {*/
   	...
   	function Sortable(element, subCatArray, idParent)
   	{
		...
		({
			type: "POST",
			dataType: "json",
			url: base_url+'admin/process/orden_categories/',
   	...
   	({
        ...
        stop:   function(event, ui)
        {
            ...
            {
            	sortable_process($(this), subCatArrayProd);
            }
        },
   	});
   	
   	function sortable_process(element, subCatArray)
   	{
		$.ajax
		({
			type: "POST",
			dataType: "json",
			url: base_url+'admin/process/orden_process/',
