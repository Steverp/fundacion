    ...
    <div class="content">
        <div class="tabs">
            ...
            <div class="form_inputs" id="page-category">
                <?php echo form_open_multipart(site_url('admin/contact_us/update_category/'.$lang_admin), ''); ?>
                <div class="inline-form">
                    <fieldset>
                        <ul>
                            ...
                            <li>
                            	...
                            	<div class="input"><?php echo form_checkbox('outstanding', '1', (isset($category->outstanding)) ? ($category->outstanding == '1' ? TRUE : FALSE) : FALSE); ?></div>
                        	</li>	
                        </ul>
                    </fieldset>
                   ...
                   <div class="buttons float-right padding-top">
                        ...
                        <a href="<?php echo site_url('admin/contact_us/index/'.$lang_admin.'/#page-structure-categories') ?>" class="btn red cancel">Cancelar</a>
                        <?php echo anchor('admin/contact_us/destroy_category/' . $category->id.'/'.$lang_admin, lang('global:delete'), array('class' => 'confirm btn red')); ?>
                    </div>
