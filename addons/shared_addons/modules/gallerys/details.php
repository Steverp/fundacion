...
class Module_gallerys extends Module {

    public $version = '1.2';
    public $mainTable = 'gallerys';
    public $chilTable = 'gallery_categories';
    public $imageTable = 'gallery_images';
    public $relationship = 'gallerys_categories';
    public $intro = 'gallerys_intro';
    ...
    public function help() {
        return "Modulo de galleryos con arbol de categorias y multiples imagenes";
    }
