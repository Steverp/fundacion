    ...
    $(document).ready(function(){
        ...
        $("#type").change(function () {
            ...
            if($tipo == 1){
                ...
                $("#content-gallery").html("<label for='name'>Imagen<small>- Imagen Permitidas gif | jpg | png | jpeg<br></small></label><div class='input'><div class='btn-false'><div class='btn'>Examinar</div><input type='file' name='content' value=''></div></div><br class='clear'>");
            }if($tipo == 2){
                $("#title").html("");
