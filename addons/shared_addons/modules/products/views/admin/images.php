<section class="title">
    ...
    <a href="<?php echo site_url('admin/products') ?>" class="btn small">Volver a los Productos</a>
</section>
<section class="item">
    <div class="content">
        <div class="tabs">
                                ...
                                <?php foreach ($images as $image): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo anchor('admin/products/edit_image/' . $image->id.'/'.$product->id, lang('global:edit'), array('class' => 'btn red small button')) ?>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
