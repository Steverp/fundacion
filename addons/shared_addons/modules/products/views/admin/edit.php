    ...
    <div class="content">
        <div class="tabs">
            ...
            <div class="form_inputs" id="page-product">
                <?php echo form_open_multipart(site_url('admin/products/update/'.$lang_admin), 'id="form-wysiwyg"'); ?>
                        ...
                        <li>
                            ...
                            <select name="category">
                                ...
                                <?php foreach ($categories as $item): ?>
                                    <option value="<?php echo $item->id; ?>" <?php echo ($item->id==$product->name) ? 'selected' : '' ?>>
                                        <?php echo $item->title; ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
