<section class="title">
    ...
    <a href="<?php echo site_url(); ?>admin/about_us/index/es"> <img src="<?php echo site_url(); ?>uploads/default/<?php echo ($lang_admin == 'es' ? 'es_img.png' : 'es_img_gris.png') ?>" width="50" height="40"/> </a>
    <a href="<?php echo site_url(); ?>admin/about_us/index/en"> <img src="<?php echo site_url(); ?>uploads/default/<?php echo ($lang_admin == 'en' ? 'en_img.png' : 'en_img_gris.png') ?>" width="50" height="40"/> </a>
    <br>
    ...
    <div class="content">
        <div class="tabs">
            ...
            <div class="form_inputs" id="page-view">
                <?php echo form_open_multipart(site_url('admin/about_us/index/'.$lang_admin), 'id="form-wysiwyg"'); ?>
