...
$(document).ready(function()
{
	...
	$(document).on("click ", ".outstanding_service", function(event)
	{
        ...
        $(document).on("click ", ".sections", function(event)
    ...
    {*/
   	...
   	({
        ...
        stop:   function(event, ui)
        {
            ...
            {
            	sortable_services($(this), subCatArrayProd);
            }
        },
   	});
   	
   	function sortable_services(element, subCatArray)
   	{
		$.ajax
		({
			type: "POST",
			dataType: "json",
			url: base_url+'admin/services/orden_services/',
